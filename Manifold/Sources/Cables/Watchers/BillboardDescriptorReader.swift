...
enum BillboardDescriptorReader {
    ...
    private nonisolated(unsafe) static let plugInTypeID = CFUUIDGetConstantUUIDWithBytes(nil,
        0xC2, 0x44, 0xE8, 0x58, 0x10, 0x9C, 0x11, 0xD4,
        0x91, 0xD4, 0x00, 0x50, 0xE4, 0xC6, 0x42, 0x6F) // kIOCFPlugInInterfaceID
    private nonisolated(unsafe) static let userClientTypeID = CFUUIDGetConstantUUIDWithBytes(nil,
        0x9D, 0xC7, 0xB7, 0x80, 0x9E, 0xC0, 0x11, 0xD4,
        0xA5, 0x4F, 0x00, 0x0A, 0x27, 0x05, 0x28, 0x61) // kIOUSBDeviceUserClientTypeID
    private nonisolated(unsafe) static let deviceInterfaceID = CFUUIDGetConstantUUIDWithBytes(nil,
