...
/// list of `ThunderboltSwitch` models. Modelled on `CablePortWatcher`:
///
...
public final class ThunderboltWatcher: ObservableObject {
    ...
    public func start() {
        ...
        // CablePortWatcher and PDIdentityWatcher.
    ...
    /// snapshot read, mirroring `CablePortWatcher.refresh()`. Property
    ...
    /// without polling. Same pattern as `CablePortWatcher.registerInterest`.
