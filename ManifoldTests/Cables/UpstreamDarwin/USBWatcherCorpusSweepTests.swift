...
@Suite("USBWatcher corpus sweep - hub nesting and tunnel classification", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
