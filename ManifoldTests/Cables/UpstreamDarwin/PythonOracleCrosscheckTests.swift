...
@Suite("Python oracle crosscheck - cable e-marker identity", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
...
@Suite("Python oracle crosscheck - device identity", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
...
@Suite("Python oracle crosscheck - zeroed-VID trust flag", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
...
@Suite("Python oracle crosscheck - TRM restriction count", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
...
@Suite("Python oracle crosscheck - CIO block count", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
...
@Suite("Python oracle crosscheck - advanced PD kinds", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
