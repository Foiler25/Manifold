...
public enum ProbeCorpus {
    ...
    /// The supplied upstream checkout may omit the private/raw customer-probe
    /// corpus even though its tests refer to it as tracked. Corpus suites use
    /// this flag to report an explicit skip instead of failing on missing data.
    public static var isAvailable: Bool {
        FileManager.default.fileExists(
            atPath: root.appendingPathComponent("corpus.jsonl").path
        )
    }
