...
@Suite("Customer-probe corpus coverage", .disabled(if: !ProbeCorpus.isAvailable, "Customer-probe corpus is absent from the supplied upstream clone."))
struct CorpusCoverageTests {
    private static let corpusURL: URL = {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()   // Manifold port's extra Cables level
