...
struct CableTrustCorpusTests {
    ...
    /// Locate the carried upstream known-cable fixture from this test file.
    private static func corpusURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()   // UpstreamCore
            .deletingLastPathComponent()   // Cables
            .appendingPathComponent("Fixtures/known-cables.md")
    }
